...
- Minimize blast radius. Make the smallest change that satisfies the requirements. Don't refactor adjacent code, add abstractions "for later," or clean up things that aren't broken.
